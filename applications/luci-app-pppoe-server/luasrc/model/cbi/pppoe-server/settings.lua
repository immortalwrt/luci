...
o.description = translate("Enable or disable the PPPoE server")
o.rmempty = false

o = s:option(ListValue, "client_interface", translate("Client Interface"))
o.description = translate("Listen in this interface")
...
o.description = translate("PPPoE Server IP address.default: 10.0.1.1")
o.datatype = "ipaddr"
...
o.description = translate("PPPoE Client IP address.default: 10.0.1.100-254")
o.placeholder = translate("10.0.1.100-254")
o.rmempty = true
o.default = "10.0.1.100-254"

o = s:option(Value, "count", translate("Client upper limit"))
o.description = translate("Specify how many clients can connect to the server simultaneously.")
o.placeholder = translate("50")
o.rmempty = true
o.default = "50"

o = s:option(Value, "dns1", translate("DNS IP address1"))
o.description = translate("Set the PPPoE server to default DNS server, which is not required.")
o.placeholder = translate("10.0.1.1")
o.datatype = "ipaddr"
o.default = "10.0.1.1"

o = s:option(Value, "dns2", translate("DNS IP address2"))
o.description = translate("Set the PPPoE server to default DNS server, which is not required.")
o.placeholder = translate("119.29.29.29")
o.datatype = "ipaddr"
o.default = "119.29.29.29"

o = s:option(Value, "mru", translate("mru"))
o.description = translate("You may not be able to access the Internet if you don't set it up properly.default: 1492")
o.default = "1492"
...
o.description = translate("Specify interface forwarding traffic.")
...
o.description = translate("Log save path, default: /var/log/pppoe-server.log")
