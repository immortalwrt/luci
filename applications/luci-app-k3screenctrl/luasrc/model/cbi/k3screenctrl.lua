...
o = s:option(ListValue, "screen_time", translate("Screen time :"))
o.description = translate("This time no action, the screen will close.")
...
o = s:option(ListValue, "refresh_time", translate("Refresh interval :"))
o.description = translate("Screen data refresh interval.")
...
o.description = translate("Input private key, visit: https://docs.seniverse.com/api/start/key.html")

o = s:option(Flag, "city_checkip", translate("Check city from ip"))
o.description = translate("Check city from local ip.")
o.default = 0

o = s:option(Value, "city", translate("City :")) 
o.description = translate("For more information, visit: https://docs.seniverse.com/api/start/common.html#地点-location")
--o.rmempty = false

o = s:option(Flag, "psk_hide", translate("Hide Wireless password"))
o.default = 0

o = s:option(Flag, "cputemp", translate("Display CPU temperature"))
o.description = translate("The first page shows more information including: CPU temprature, Load, RAM useage, uptime, etc.")
o.default = 0

o = s:option(Button, "test_print", translate("Test"))
o.description = translate("Execute k3screenctrl -t and return the result")
...
s = m:section(TypedSection, "device_custom")
s.title = translate("Device customization")
s.description = translate("Customize the fifth page of device information")
