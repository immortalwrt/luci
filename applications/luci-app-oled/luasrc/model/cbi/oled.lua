m = Map("oled", translate("OLED"))
m.description = translate("A LuCI app that helps you config your oled display (SSD1306, 0.91', 128X32) with screensavers! <br /> <br /> Any issues, please go to: ")..[[<a href="https://github.com/natelol/luci-app-oled" target="_blank">luci-app-oled</a>]]

--m.chain("luci")

m:section(SimpleSection).template  = "oled/oled_status"
...
--informtion  options----
o = s:taboption("info", Flag, "date", translate("Date"))
o.description = translate('Format YYYY-MM-DD HH:MM:SS')
o.default = 0

o = s:taboption("info", Flag, "lanip", translate("IP"))
o.description = translate("LAN IP address")
o.default = 0
...
o.description = translate("1Mbps(m/s)=1,000Kbps(k/s)=1,000,000bps(b/s)")
o.default = 0
...
o.description = translate('Screensaver will activate in set seconds')
o.default = 0
